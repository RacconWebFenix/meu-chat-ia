...
interface UseExportReturn {
  ...
  readonly exportToCSV: (matches: readonly EquivalenceMatch[], options?: ExportOptions) => Promise<void>;
  readonly exportToExcel: (matches: readonly EquivalenceMatch[], options?: ExportOptions) => Promise<void>;
  readonly exportToPDF: (matches: readonly EquivalenceMatch[], options?: ExportOptions) => Promise<void>;
}
