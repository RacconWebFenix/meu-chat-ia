...
// Opções de dimensões baseadas na sua query SQL
const DIMENSION_OPTIONS: DimensionOption[] = [
  ...
  { value: "FAMILIA", label: "Família de Itens", dataType: "string" },
  ...
  { value: "UNID_MEDIDA", label: "Unid. Medida", dataType: "string" },
...
// Opções de métricas (campos numéricos)
